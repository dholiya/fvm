class SellerProductsModel {
  int? status;
  List<SellerProductsModelData>? data;

  SellerProductsModel({this.status, this.data});

  SellerProductsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <SellerProductsModelData>[];
      json['data'].forEach((v) {
        data!.add(new SellerProductsModelData.fromJson(v));
      });
    }
  }
...
class SellerProductsModelData {
  ...
  SellerProductsModelData(
      {this.images,
        ...
        this.createdAt,
        this.updatedAt,
        this.iV, this.buyerId,
        this.buyerEmail});

  SellerProductsModelData.fromJson(Map<String, dynamic> json) {
